    ...
    def __init__(
        ...
        **kwargs
        ...
        layers = [
            ...
            _stack(depths[5], depths[6], 5, 1 if better else 2, 6, 4, _BN_MOMENTUM),
...
@register_model
def better_mnasnet0_5(pretrained: bool = False, progress: bool = True, **kwargs: Any) -> MNASNet:
    r"""MNASNet with depth multiplier of 0.5 from
    `"MnasNet: Platform-Aware Neural Architecture Search for Mobile"
    <https://arxiv.org/pdf/1807.11626.pdf>`_.
    ...
    Args:
        ...
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    model = MNASNet(0.5, better=True, **kwargs)
    if pretrained:
        _load_pretrained("mnasnet0_5", model, progress)
    return model
...
@register_model
def better_mnasnet0_75(pretrained: bool = False, progress: bool = True, **kwargs: Any) -> MNASNet:
    r"""MNASNet with depth multiplier of 0.75 from
    `"MnasNet: Platform-Aware Neural Architecture Search for Mobile"
    <https://arxiv.org/pdf/1807.11626.pdf>`_.
    ...
    Args:
        ...
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    model = MNASNet(0.75, better=True, **kwargs)
    if pretrained:
        _load_pretrained("mnasnet0_75", model, progress)
    return model
...
@register_model
def better_mnasnet1_0(pretrained: bool = False, progress: bool = True, **kwargs: Any) -> MNASNet:
    r"""MNASNet with depth multiplier of 1.0 from
    `"MnasNet: Platform-Aware Neural Architecture Search for Mobile"
    <https://arxiv.org/pdf/1807.11626.pdf>`_.
    ...
    Args:
        ...
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    model = MNASNet(1.0, better=True, **kwargs)
    if pretrained:
        _load_pretrained("mnasnet1_0", model, progress)
    return model
...
@register_model
def better_mnasnet1_3(pretrained: bool = False, progress: bool = True, **kwargs: Any) -> MNASNet:
    r"""MNASNet with depth multiplier of 1.3 from
    `"MnasNet: Platform-Aware Neural Architecture Search for Mobile"
    <https://arxiv.org/pdf/1807.11626.pdf>`_.
    ...
    Args:
        ...
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    model = MNASNet(1.3, better=True, **kwargs)
    if pretrained:
        _load_pretrained("mnasnet1_3", model, progress)
    return model
