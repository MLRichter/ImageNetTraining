...
class ResNet(nn.Module):
    def __init__(self, block, layers, dataset, mode, input_shape=32, output_shape=8, sa_num=None, strides=[1, 2, 2, 2], num_classes=1000, **kwargs):
...
class MobileNetV2(nn.Module):
    def __init__(self, dataset=None, width_mult=1.0, inverted_residual_setting=None, round_nearest=8, mode=None,
                 input_shape=32, output_shape=16, sa_num=None, better=False, num_classes=1000, **kwargs):
        """
...
@register_model
def better_resnet50_sa(pretrained: bool = False, progress: bool = True, **kwargs: Any) -> ResNet:
